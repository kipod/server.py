...
def generate_map03(db):
    ...
    # Posts:
    db.add_post(p1, 'town-one', PostType.TOWN, population=3, product=35)
    db.add_post(p98, 'market-big', PostType.MARKET, product=36, replenishment=2)
    db.add_post(p49, 'market-medium', PostType.MARKET, product=28, replenishment=1)
    db.add_post(p12, 'market-small', PostType.MARKET, product=5, replenishment=1)

    # Lines:
    db.add_line(10, p1, p2)
    db.add_line(10, p2, p3)
    db.add_line(10, p3, p4)
    db.add_line(10, p4, p5)
    db.add_line(10, p5, p6)
    db.add_line(10, p6, p7)
    db.add_line(10, p7, p8)
    db.add_line(10, p8, p9)
    db.add_line(10, p9, p10)

    db.add_line(10, p1, p11)
    db.add_line(10, p2, p12)
    db.add_line(10, p3, p13)
    db.add_line(10, p4, p14)
    db.add_line(10, p5, p15)
    db.add_line(10, p6, p16)
    db.add_line(10, p7, p17)
    db.add_line(10, p8, p18)
    db.add_line(10, p9, p19)
    db.add_line(10, p10, p20)


    db.add_line(10, p11, p12)
    db.add_line(10, p12, p13)
    db.add_line(10, p13, p14)
    db.add_line(10, p14, p15)
    db.add_line(10, p15, p16)
    db.add_line(10, p16, p17)
    db.add_line(10, p17, p18)
    db.add_line(10, p18, p19)
    db.add_line(10, p19, p20)

    db.add_line(10, p11, p21)
    db.add_line(10, p12, p22)
    db.add_line(10, p13, p23)
    db.add_line(10, p14, p24)
    db.add_line(10, p15, p25)
    db.add_line(10, p16, p26)
    db.add_line(10, p17, p27)
    db.add_line(10, p18, p28)
    db.add_line(10, p19, p29)
    db.add_line(10, p20, p30)


    db.add_line(10, p21, p22)
    db.add_line(10, p22, p23)
    db.add_line(10, p23, p24)
    db.add_line(10, p24, p25)
    db.add_line(10, p25, p26)
    db.add_line(10, p26, p27)
    db.add_line(10, p27, p28)
    db.add_line(10, p28, p29)
    db.add_line(10, p29, p30)

    db.add_line(10, p21, p31)
    db.add_line(10, p22, p32)
    db.add_line(10, p23, p33)
    db.add_line(10, p24, p34)
    db.add_line(10, p25, p35)
    db.add_line(10, p26, p36)
    db.add_line(10, p27, p37)
    db.add_line(10, p28, p38)
    db.add_line(10, p29, p39)
    db.add_line(10, p30, p40)

    db.add_line(10, p31, p32)
    db.add_line(10, p32, p33)
    db.add_line(10, p33, p34)
    db.add_line(10, p34, p35)
    db.add_line(10, p35, p36)
    db.add_line(10, p36, p37)
    db.add_line(10, p37, p38)
    db.add_line(10, p38, p39)
    db.add_line(10, p39, p40)

    db.add_line(10, p31, p41)
    db.add_line(10, p32, p42)
    db.add_line(10, p33, p43)
    db.add_line(10, p34, p44)
    db.add_line(10, p35, p45)
    db.add_line(10, p36, p46)
    db.add_line(10, p37, p47)
    db.add_line(10, p38, p48)
    db.add_line(10, p39, p49)
    db.add_line(10, p40, p50)


    db.add_line(10, p41, p42)
    db.add_line(10, p42, p43)
    db.add_line(10, p43, p44)
    db.add_line(10, p44, p45)
    db.add_line(10, p45, p46)
    db.add_line(10, p46, p47)
    db.add_line(10, p47, p48)
    db.add_line(10, p48, p49)
    db.add_line(10, p49, p50)

    db.add_line(10, p41, p51)
    db.add_line(10, p42, p52)
    db.add_line(10, p43, p53)
    db.add_line(10, p44, p54)
    db.add_line(10, p45, p55)
    db.add_line(10, p46, p56)
    db.add_line(10, p47, p57)
    db.add_line(10, p48, p58)
    db.add_line(10, p49, p59)
    db.add_line(10, p50, p60)


    db.add_line(10, p51, p52)
    db.add_line(10, p52, p53)
    db.add_line(10, p53, p54)
    db.add_line(10, p54, p55)
    db.add_line(10, p55, p56)
    db.add_line(10, p56, p57)
    db.add_line(10, p57, p58)
    db.add_line(10, p58, p59)
    db.add_line(10, p59, p60)

    db.add_line(10, p51, p61)
    db.add_line(10, p52, p62)
    db.add_line(10, p53, p63)
    db.add_line(10, p54, p64)
    db.add_line(10, p55, p65)
    db.add_line(10, p56, p66)
    db.add_line(10, p57, p67)
    db.add_line(10, p58, p68)
    db.add_line(10, p59, p69)
    db.add_line(10, p60, p70)


    db.add_line(10, p61, p62)
    db.add_line(10, p62, p63)
    db.add_line(10, p63, p64)
    db.add_line(10, p64, p65)
    db.add_line(10, p65, p66)
    db.add_line(10, p66, p67)
    db.add_line(10, p67, p68)
    db.add_line(10, p68, p69)
    db.add_line(10, p69, p70)

    db.add_line(10, p61, p71)
    db.add_line(10, p62, p72)
    db.add_line(10, p63, p73)
    db.add_line(10, p64, p74)
    db.add_line(10, p65, p75)
    db.add_line(10, p66, p76)
    db.add_line(10, p67, p77)
    db.add_line(10, p68, p78)
    db.add_line(10, p69, p79)
    db.add_line(10, p70, p80)


    db.add_line(10, p71, p72)
    db.add_line(10, p72, p73)
    db.add_line(10, p73, p74)
    db.add_line(10, p74, p75)
    db.add_line(10, p75, p76)
    db.add_line(10, p76, p77)
    db.add_line(10, p77, p78)
    db.add_line(10, p78, p79)
    db.add_line(10, p79, p80)

    db.add_line(10, p71, p81)
    db.add_line(10, p72, p82)
    db.add_line(10, p73, p83)
    db.add_line(10, p74, p84)
    db.add_line(10, p75, p85)
    db.add_line(10, p76, p86)
    db.add_line(10, p77, p87)
    db.add_line(10, p78, p88)
    db.add_line(10, p79, p89)
    db.add_line(10, p80, p90)


    db.add_line(10, p81, p82)
    db.add_line(10, p82, p83)
    db.add_line(10, p83, p84)
    db.add_line(10, p84, p85)
    db.add_line(10, p85, p86)
    db.add_line(10, p86, p87)
    db.add_line(10, p87, p88)
    db.add_line(10, p88, p89)
    db.add_line(10, p89, p90)
